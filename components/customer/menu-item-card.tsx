...
export function MenuItemCard({ item, onAddItem }: MenuItemCardProps) {
  ...
  return (
    ...
    >
      <Card className="h-full rounded-lg border-white/10 bg-zinc-900/78 py-0 shadow-2xl shadow-black/20 transition hover:-translate-y-1 hover:border-emerald-300/30 hover:bg-zinc-900">
